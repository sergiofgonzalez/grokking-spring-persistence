...
public class UserRepositoryIntegrationTests {
	...
	public void testCheckUserEmails() {
		List<Email> user1Emails = (List<Email>) emailRepository.findByUsersUsernameLikeIgnoringCase("%user1%");
		List<Email> user2Emails = (List<Email>) emailRepository.findByUsersUsernameLikeIgnoringCase("%user2%");
		List<Email> user3Emails = (List<Email>) emailRepository.findByUsersUsernameLikeIgnoringCase("%user3%");
